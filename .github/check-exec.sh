...
# Make sure no files in the www dir are executable
EXEC_PERM_COUNT=$(find www/docs -type f -perm /111 | wc -l)
echo "=> Checking $(pwd)/www for executable permissions..."
echo
